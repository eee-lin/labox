//
//  Timeline_1_TableViewCell.swift
//  labox
//
...
protocol Timeline_1_TableViewCellDelegate {
    func didTapLikeButton(tableViewCell: UITableViewCell, button: UIButton)
    func didTapMenuButton(tableViewCell: UITableViewCell, button: UIButton)
}

class Timeline_1_TableViewCell: UITableViewCell {
    
    var delegate: Timeline_1_TableViewCellDelegate?
