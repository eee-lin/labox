//
//  Timeline_3_TableViewCell.swift
//  labox
//
...
protocol Timeline_3_TableViewCellDelegate {
    func didTapLikeButton(tableViewCell: UITableViewCell, button: UIButton)
    func didTapMenuButton(tableViewCell: UITableViewCell, button: UIButton)
}

class Timeline_3_TableViewCell: UITableViewCell {
    
    var delegate: Timeline_3_TableViewCellDelegate?
    ...
    @IBOutlet var up3ImageView: UIImageView!
